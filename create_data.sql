...
SELECT new_plate_set('using loop1','ps-name-by-user1',20,96,1,10,TRUE);
SELECT new_plate_set('using loop2','ps-name-by-user2',20,96,1,10,TRUE);
SELECT new_plate_set('using loop3','ps-name-by-user3',20,384,1,10,TRUE);
SELECT new_plate_set('using loop4','ps-name-by-user4',20,384,1,10,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,384,1,10,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,384,2,10,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,384,2,10,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,1536,1,10,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,1536,1,10,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,1536,1,10,TRUE);

SELECT new_plate_set('using loop1','ps-name-by-user1',20,96,1,9,TRUE);
SELECT new_plate_set('using loop2','ps-name-by-user2',20,96,1,9,TRUE);
SELECT new_plate_set('using loop3','ps-name-by-user3',20,384,1,9,TRUE);
SELECT new_plate_set('using loop4','ps-name-by-user4',20,384,1,9,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,384,1,9,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,384,2,9,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,384,2,9,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,1536,1,9,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,1536,1,9,TRUE);
SELECT new_plate_set('using loop5','ps-name-by-user5',20,1536,1,9,TRUE);

SELECT new_plate_set('for data import','ps-name-96 well',2,96,1,1,TRUE);
...
select new_assay_run( 'assay_run1', 'descr for assay run 1', 1, 1, 1);
select new_assay_run( 'assay_run2', 'descr for assay run 2', 1, 1, 1);
select new_assay_run( 'assay_run3', 'descr for assay run 3', 1, 1, 1);
select new_assay_run( 'assay_run4', 'descr for assay run 4', 1, 1, 1);
select new_assay_run( 'assay_run5', 'descr for assay run 5', 1, 1, 1);
